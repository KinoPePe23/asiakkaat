	...
	<table id="listaus">
		<thead>
			<tr>
				...
				<th colspan="1" class="oikealle"><a id="uusiAsiakas" href="lisaaasiakas.jsp">Lisää uusi asiakas</a></th>
			</tr>
			<tr>
			...
			if(confirm("Poista asiakas " + asiakas_id + " " + etunimi + " " + sukunimi +"?")){	
				...
				.then(function (responseJson) {		
					...
					if(vastaus==0){
			        	...
			        	document.getElementById("ilmo").innerHTML="Asiakkaan " + asiakas_id + " " + etunimi + "" + sukunimi +" poisto onnistui.";
						haeTiedot();        	
					}	
